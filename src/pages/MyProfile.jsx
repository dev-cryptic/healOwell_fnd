    ...
    <div className='max-w-lg mx-auto flex flex-col gap-4 p-6 bg-white shadow-md rounded-lg'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p className='text-[#216B7B]'>{userData.email}</p>
      ...
      <div className='mt-10'>
        {isEdit ? (
          <button 
            className='border border-[#216B7B] px-8 py-2 rounded-full hover:bg-[#216B7B] hover:text-white transition-all duration-300' 
